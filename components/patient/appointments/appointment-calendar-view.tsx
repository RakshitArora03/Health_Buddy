...
export function AppointmentCalendarView({ appointments, onAppointmentClick }: AppointmentCalendarViewProps) {
  ...
  const events = appointments.map((appointment) => {
    ...
    return {
      ...
      title: `${appointment.doctorName || "Doctor"} - ${appointment.type === "online" ? "Online" : "In-Person"}`,
      start: startDate,
      end: endDate,
