...
import { LayoutDashboard, Users, Calendar, MessageSquare, UserCircle, LogOut, Menu } from "lucide-react"
        ...
        <div className="md:hidden flex justify-between items-center p-4 bg-[#006D5B] text-white">
          ...
          <div>
            <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
              ...
              <SheetContent side="left" className="w-[260px] sm:w-[300px] bg-[#006D5B] text-white">
                <SheetTitle asChild>
